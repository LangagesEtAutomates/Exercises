...
\typeTP[4]
\title{Typage dynamique d'expressions}

\hypersetup{
  pdftitle  = {Langages et Automates - TP 4 - Typage dynamique d'expressions},
  pdfauthor = {Matthieu Perrin},
  pdfsubject  = {TP de L2 en Langages et Automates},
  pdfkeywords = {types dynamiques, contexte, environnement, évaluation}
}

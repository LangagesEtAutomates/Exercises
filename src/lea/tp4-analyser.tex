...
\begin{exercice}[Détection de code mort]
  ...
  \lstinline|Analyser.Context.afterBreak|, initialement \lstinline|false|,
  est mis à \lstinline|true| lorsqu'on analyse \lstinline|interrompre|.
  ...
  \item Adaptez l'analyse statique afin de détecter lorsqu'une instruction est \emph{forcément}
    ...
    Lorsqu'une instruction \lstinline|instr| est analysée avec \lstinline|afterBreak = true|,
    une erreur doit être signalée en utilisant : 
    \lstinline|throw error(instr, "Code mort : instruction inatteignable");|
  \end{question}
  \begin{correction}
    \begin{lstlisting}[gobble=6]
